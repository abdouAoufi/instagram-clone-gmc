const Navbar = () => {
  return (
    <nav className="flex  justify-around items-center border-b">
      <img
        src="https://instgram-clone.pages.dev/assets/instagram.e5b60ee0.png"
        className="w-20 h-16 cover"
      />

      <div
        className={`justify-between text-sm py-1 flex p-0.5 items-center  h-10  w-59 border border-gray-200 rounded `}
      >
        <img
          src="https://instgram-clone.pages.dev/assets/search.bb0ba1b7.svg"
          width="20"
          height="12"
      ...
      <div className="flex items-center relative gap-6 ">
        ...
        <div className={`cursor-pointer `} href="/direct/inbox/">
          <svg
